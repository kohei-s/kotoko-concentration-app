...
This mobile application is developed 🛠️ as my personal capstone project for [Java Development Bootcamp at neue fische](https://www.neuefische.de/en/bootcamp/java-development) from May to August 2023  (👉 [ver.1](https://cgn-java-23-2-kohei.capstone-project.de/login))
